                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-evenly pt-5">
                            <a href="{{ route('admin.centers.edit', $center) }}" class="btn btn-light text-center text-uppercase fw-semibold px-5 py-3">Edit</a>
                            <form action="{{ route('admin.centers.destroy', $center) }}" method="post">
                                @method('delete')
                                @csrf
                                <x-primary-button class="btn btn-light border-0 text-dark text-center text-uppercase fw-semibold px-5 py-3" onclick="return confirm ('Are you sure you want to delete this center?')" >
                                    Delete
                                </x-primary-button>
                            </form>
                        </div>
